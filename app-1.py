...
def index():
    ...
    for brewery in breweries:
        yelp_url = f"https://api.yelp.com/v3/businesses/search?latitude={brewery['latitude']}&longitude={brewery['longitude']}&categories=&sort_by=best_match"
    headers = {
        'Authorization': 'Bearer YOUR_YELP_API_KEY',  # Replace with your actual Yelp API key
    }
